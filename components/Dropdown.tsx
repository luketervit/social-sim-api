    ...
    <div ref={containerRef} className="dropdown-root" style={{ position: "relative" }}>
      <button
        ...
        style={{
          ...
          border: open ? "1px solid rgba(212, 212, 216, 0.5)" : "1px solid rgba(39, 39, 42, 0.8)",
          outline: "none",
          cursor: "pointer",
          minHeight: 44,
          textAlign: "left",
            ...
            return (
              <li
                ...
                style={{
                  ...
                  background: isFocused ? "rgba(39, 39, 42, 0.6)" : "transparent",
                  cursor: "pointer",
                  minHeight: 44,
              ...
              >
                <span
                  style={{
                    ...
                    textAlign: "center",
                    fontSize: 12,
                    color: isSelected ? "var(--text-primary)" : "transparent",
                  }}
                  aria-hidden="true"
                >
                  ✓

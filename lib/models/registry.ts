...
export const GENERATORS: GeneratorModel[] = [
  ...
  },
  {
    ...
    refusal_posture: "aligned",
    notes:
      "Cheap, solid long-context multilingual instruct model on OpenRouter. Better value than older 70B instruct options for detailed but still aligned writing.",
  },
  {
    id: "qwen-3-32b",
  ...
  },
  {
    ...
    refusal_posture: "permissive",
    notes:
      "Large MoE instruct model with very low OpenRouter pricing and strong structured-output adherence. Good when you need smarter generation without Claude-level pricing.",
  },
  {
